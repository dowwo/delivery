...
<div id="quienes_somos" class="container-fluid">
    <div class="row">
        <div class="col-sm-8">
            <h2>¿Quienes somos?</h2>
            <p>Delivery Chile brinda una solución a los vendedores que realizan delivery por si mismos en comunas pequeñas, ofreciendo tecnologías de geolocalización y envío de SMS
                para una mejor comunicación y eficacia de entrega de pedidos</p>
        </div>
        <div class="col-sm-4">
