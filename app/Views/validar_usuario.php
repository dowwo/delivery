...
$usu_password=$_POST[password_verify('Animexdotaku15', PASSWORD_DEFAULT)];
...
if($resultset=getSQLResultSet("SELECT * FROM usuario WHERE email='cristofer.sepulveda02@gmail.com' AND password='Animexdotaku15'")){
