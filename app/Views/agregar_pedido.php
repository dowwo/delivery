...
*/
            ...
            function deleteMarkers() {
                document.getElementById('InputForLatitud').value = "";
                document.getElementById('InputForLongitud').value = "";
                hideMarkers();
                markers = [];
            }
        ...
        <div class="col-6">
            ...
            <form action="/PedidoController/guardar" method="post">
                ...
                <div>
                    ...
                    <input id="delete-markers" type="button" value="Reiniciar dirección" class="btn btn-danger"/>
                    <br>
                </div>
