                        ...
                        <form method="post" action="<?= site_url('/PedidoController/update') ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estado" id="InputForEstado" class="form-select" aria-label="Default select example">
                                    <option <?php if ($pedido_obj['estado_id_esatdo']="1") echo 'selected'; ?> value="1"En Espera</option>
                                    <option <?php if ($pedido_obj['estado_id_esatdo']="2") echo 'selected'; ?> value="2"En Reparto</option>
                                    <option <?php if ($pedido_obj['estado_id_esatdo']="3") echo 'selected'; ?> value="3"Entregado</option>
                                    <option <?php if ($pedido_obj['estado_id_esatdo']="4") echo 'selected'; ?> value="4"Cancelado</option>
